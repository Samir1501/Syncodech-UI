...
namespace Syncodech.UI
{
    ...
    public class UIElementEditor : Editor
    {
        ...
        private SerializedProperty _prefabPrp;
        private SerializedProperty _containerPrp;

        private SerializedProperty _confirmBtnPrp;
        private SerializedProperty _rejectBtnPrp;
        ...
        private SerializedProperty _onConfirmedEventPrp;
        private SerializedProperty _onRejectedEventPrp;
        ...
        private void InitProperty()
        {
            ...
            _confirmBtnPrp = serializedObject.FindProperty("confirmButton");
            _rejectBtnPrp = serializedObject.FindProperty("rejectButton");
            ...
            _containerPrp = serializedObject.FindProperty("container");
            _prefabPrp = serializedObject.FindProperty("prefab");
            ...
            _onConfirmedEventPrp = serializedObject.FindProperty("onConfirmed");
            _onRejectedEventPrp = serializedObject.FindProperty("onRejected");
        }
        ...
        private float ElementHeightCallback(int index)
        {
            ...
            return type switch
            {
                TransitionType.Color => element.isExpanded
                    ? VerticalPos * target switch
                    {
                        Toggle => 7,
                        RadioButton => 7,
                        _ => 6
                    ...
                    : VerticalPos,
                TransitionType.Sprite => element.isExpanded
                    ? VerticalPos * target switch
                    {
                        Toggle => 7,
                        RadioButton => 7,
                    ...
                    : VerticalPos,
                TransitionType.Transform => element.isExpanded
                    ? VerticalPos * target switch
                    {
                        Toggle => 27,
                        RadioButton => 27,
        ...
        private void SingleLineProperty(int order, Rect rect, SerializedProperty prp, string displayName,
            string relativePropertyName = "")
        {
            float y = rect.y + 2.5f;
            SerializedProperty property = string.IsNullOrEmpty(relativePropertyName)
                ? prp
                : prp.FindPropertyRelative(relativePropertyName);
            EditorGUI.PropertyField(new Rect(rect.x, y + VerticalPos * order, rect.width, _elementHeight), property,
        ...
        private void DrawActiveElementCallback(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            SerializedProperty pressed =
                element.FindPropertyRelative(activeMode.boolValue ? "activePressed" : "pressed");
            SerializedProperty selected =
                element.FindPropertyRelative(activeMode.boolValue ? "activeSelected" : "selected");
            SerializedProperty disabled =
                element.FindPropertyRelative(activeMode.boolValue ? "activeDisabled" : "disabled");
            ...
            element.isExpanded = EditorGUI.Foldout(new Rect(x, y, rect.width, _elementHeight + 2), element.isExpanded,
                GUIContent.none);
            EditorGUI.PropertyField(new Rect(x + Margin + 2, y, halfWidth - Margin - 2, _elementHeight),
                element.FindPropertyRelative("graphic"), GUIContent.none);
            EditorGUI.PropertyField(new Rect(x + Margin + halfWidth, y, halfWidthHalf, _elementHeight),
                element.FindPropertyRelative("transition"), GUIContent.none);
            EditorGUI.PropertyField(
                new Rect(x + Margin * 2 + halfWidth + halfWidthHalf, y, halfWidthHalf, _elementHeight),
        ...
        private void GraphicsListElementGUI(TransitionType type, ref int order, Rect rect, SerializedProperty normal,
            SerializedProperty hover, SerializedProperty pressed, SerializedProperty selected,
            SerializedProperty disabled)
        {
            float y = rect.y + 2.5f;
            ...
            switch (type)
            {
                ...
                case TransitionType.Transform:
                    EditorGUI.SelectableLabel(new Rect(rect.x, y + VerticalPos * order++, rect.width, _elementHeight),
                        "Normal", GUI.skin.box);
        ...
        private void ChildFields<T>()
        {
            if(serializedObject.targetObject.GetType() == typeof(T)) return;
            ...
            EditorGUILayout.LabelField($"{serializedObject.targetObject.GetType()} fields",EditorStyles.boldLabel);
        ...
        private void ModalGUI()
        {
            ...
            EditorGUILayout.PropertyField(_confirmBtnPrp);
            if(_confirmBtnPrp.objectReferenceValue != null)
                EditorGUILayout.PropertyField(_onConfirmedEventPrp);
            EditorGUILayout.PropertyField(_rejectBtnPrp);
            if(_rejectBtnPrp.objectReferenceValue != null)
                EditorGUILayout.PropertyField(_onRejectedEventPrp);
        }
        ...
        private void PanelGUI()
        {
            ...
            _openSidePrp.enumValueIndex = GUILayout.SelectionGrid(_openSidePrp.enumValueIndex,
                _openSidePrp.enumDisplayNames, 4, EditorStyles.miniButtonMid);
            EditorGUILayout.EndVertical();
            EditorGUILayout.BeginVertical(EditorStyles.helpBox);
            EditorGUILayout.LabelField("Close side");
            _closeSidePrp.enumValueIndex = GUILayout.SelectionGrid(_closeSidePrp.enumValueIndex,
                _closeSidePrp.enumDisplayNames, 4, EditorStyles.miniButtonMid);
            EditorGUILayout.EndVertical();
        ...
        private void BarGUI()
        {
            ...
            _barTypePrp.enumValueIndex = GUILayout.SelectionGrid(_barTypePrp.enumValueIndex,
                _barTypePrp.enumDisplayNames, 2, EditorStyles.miniButtonMid);
        ...
        private void RadioButtonGroupGUI()
        {
            ...
            EditorGUILayout.BeginVertical(EditorStyles.helpBox);
            EditorGUILayout.LabelField($"Current index : {_currentIndexPrp.intValue}", EditorStyles.miniLabel);
            EditorGUILayout.LabelField($"Next index : {_nextIndexPrp.intValue}", EditorStyles.miniLabel);
            EditorGUILayout.EndVertical();
            EditorGUILayout.Space(5);
            EditorGUILayout.PropertyField(_prefabPrp);
            if (_prefabPrp.objectReferenceValue != null)
            {
                EditorGUILayout.PropertyField(_containerPrp);
            }
            EditorGUILayout.Space(5);
